...
export default function WebDevServicesLineTablet() {
  ...
  const pathLength4 = useTransform(scrollYProgress, [0.5, 1], [0, 1]);
  ...
  return (
    <section ref={ref} style={sectionContainer}>
      <div style={container}>
        ...
        {/* Line 1 */}
        <svg style={{ ...lineContainer, top: '280px', height: '2400px' }} viewBox="0 0 400 2240" preserveAspectRatio="xMidYMin meet">
          <defs>
          ...
          <path d="M 200 0 L 200 2240" stroke="#00A8FF" strokeWidth="2.5" fill="none" strokeLinecap="square" strokeLinejoin="miter" opacity="0.2" />
          <motion.path d="M 200 0 L 200 2400" stroke="#00A8FF" strokeWidth="2.5" fill="none" strokeLinecap="square" strokeLinejoin="miter" filter="url(#glow)" pathLength={pathLength1} />
        </svg>
        ...
        {/* Line 2 */}
        <svg style={{ ...lineContainer, top: '2850px', height: '2800px' }} viewBox="0 0 400 2800" preserveAspectRatio="xMidYMin meet">
          <defs>
          ...
          <path d="M 200 0 L 200 2410" stroke="#00A8FF" strokeWidth="2.5" fill="none" strokeLinecap="square" strokeLinejoin="miter" opacity="0.2" />
          <motion.path d="M 200 0 L 200 2410" stroke="#00A8FF" strokeWidth="2.5" fill="none" strokeLinecap="square" strokeLinejoin="miter" filter="url(#glow)" pathLength={pathLength2} />
        </svg>
        ...
        {/* Line 3 */}
        <svg style={{ ...lineContainer, top: '5600px', height: '900px' }} viewBox="0 0 400 900" preserveAspectRatio="xMidYMin meet">
          <defs>
            <filter id="glow-tablet-3">
              <feGaussianBlur stdDeviation="10" result="coloredBlur"/>
              <feMerge>
                <feMergeNode in="coloredBlur"/>
                <feMergeNode in="SourceGraphic"/>
          ...
          <path d="M 200 0 L 200 730" stroke="#00A8FF" strokeWidth="2.5" fill="none" strokeLinecap="square" strokeLinejoin="miter" opacity="0.2" />
          <motion.path d="M 200 0 L 200 730" stroke="#00A8FF" strokeWidth="2.5" fill="none" strokeLinecap="square" strokeLinejoin="miter" filter="url(#glow)" pathLength={pathLength3} />
        </svg>
        ...
        {/* Line 4 */}
        <svg style={{ ...lineContainer, top: '6700px', height: '700px' }} viewBox="0 0 400 700" preserveAspectRatio="xMidYMin meet">
          <defs>
            <filter id="glow-tablet-4">
              <feGaussianBlur stdDeviation="10" result="coloredBlur"/>
              <feMerge>
                <feMergeNode in="coloredBlur"/>
                <feMergeNode in="SourceGraphic"/>
          ...
          <path d="M 200 0 L 200 700" stroke="#00A8FF" strokeWidth="2.5" fill="none" strokeLinecap="square" strokeLinejoin="miter" opacity="0.2" />
          <motion.path d="M 200 0 L 200 700" stroke="#00A8FF" strokeWidth="2.5" fill="none" strokeLinecap="square" strokeLinejoin="miter" filter="url(#glow)" pathLength={pathLength4} />
        </svg>
