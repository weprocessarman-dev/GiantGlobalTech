...
export default function ServiceSectionMobile() {
    ...
    <section ref={ref} style={sectionContainer}>
      <div style={container}>
        ...
        <svg style={lineContainer} viewBox="0 0 400 1200" preserveAspectRatio="xMidYMin meet">
          ...
          <path d="M 200 0 L 200 970" stroke="#00A8FF" strokeWidth="2.5" fill="none" strokeLinecap="square" strokeLinejoin="miter" opacity="0.2" />
          <motion.path 
            d="M 200 0 L 200 970" 
            stroke="#00A8FF"
            strokeWidth="2.5"
        ...
        {/* Vertical Line 2 */}
        <svg style={{ ...lineContainer, top: '1200px', height: '1000px' }} viewBox="0 0 400 1000" preserveAspectRatio="xMidYMin meet">
          <defs>
          ...
          <path d="M 200 0 L 200 580" stroke="#00A8FF" strokeWidth="2.5" fill="none" strokeLinecap="square" strokeLinejoin="miter" opacity="0.2" />
          <motion.path 
            d="M 200 0 L 200 580" 
            stroke="#00A8FF"
            strokeWidth="2.5"
