...
const defaultOptions: HyperspeedOptions = {
  ...
  colors: {
    ...
    rightCars: [0x2563eb, 0x3b82f6, 0x93c5fd],
    sticks: 0x3b82f6
  }
};
...
const Hyperspeed: FC<HyperspeedProps> = ({ effectOptions = {}, backgroundImage }) => {
  ...
  return <div id="lights" ref={hyperspeed} style={{ mixBlendMode: 'lighten' }}></div>;
};
